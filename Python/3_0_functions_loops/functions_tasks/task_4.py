...
#               **Пример:**
# Если вызвать функцию **`count_items(1, 2, 3, 4, 5)`**, то она должна вернуть: **`5`**
# Если вызвать функцию **`count_items("apple", "banana", "cherry")`**, то она должна вернуть: **`3`**
#               **Вывод результата:**
# Количество переданных элементов: 5.
def count_items(*args: int) -> int :
    summ = 0
    for num in args:
        summ += 1
    return summ
...
result = count_items("apple", "banana", "cherry")
print(f"Количество переданных элементов: {result}")
